# BÁO CÁO ĐÁNH GIÁ VAI TRÒ KNOWLEDGE GRAPH (GRAPH GAP INTEGRATION REPORT) - BUỔI 17
...
| :--- | :--- | :---: | :--- |
| **`CONTAINS`** | `VanBan` $ightarrow$ `DieuKhoan` | `6,560` | **Quan hệ cấu trúc**: Chỉ liên kết văn bản pháp lý với các điều khoản con của chính nó. Không có tác dụng kết nối liên văn bản. |
| **`NEXT`** | `DieuKhoan` $ightarrow$ `DieuKhoan` | `6,545` | **Quan hệ cấu trúc**: Liên kết các điều khoản kế tiếp nhau trong cùng một văn bản. Chỉ giúp mở rộng ngữ cảnh đọc liền mạch, không giúp kết nối chéo giữa các quy định khác nhau. |
| **`CAN_CU`** | `VanBan` $ightarrow$ `VanBan` | `4` | **Quan hệ pháp lý**: Thể hiện căn cứ pháp lý ban hành của văn bản (chỉ giữa các văn bản bên ngoài). Không kết nối với tài liệu nội bộ. |
| **`THAY_THE`** | `VanBan` $ightarrow$ `VanBan` | `1` | **Quan hệ pháp lý**: Thể hiện lịch sử thay thế văn bản quy phạm pháp luật của nhà nước. |
| **`SUA_DOI_BO_SUNG`**| `VanBan` $ightarrow$ `VanBan` | `1` | **Quan hệ pháp lý**: Thể hiện lịch sử sửa đổi, bổ sung của các thông tư nhà nước. |
| **`HOP_NHAT`** | `VanBan` $ightarrow$ `VanBan` | `1` | **Quan hệ pháp lý**: Thể hiện liên kết văn bản hợp nhất với văn bản gốc. |
| **`VAN_BAN_BO_SUNG`**| `VanBan` $ightarrow$ `VanBan` | `1` | **Quan hệ pháp lý**: Thể hiện liên kết bổ sung thông tư của NHNN. |
