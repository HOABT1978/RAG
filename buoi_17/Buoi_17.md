...
```env
# Dữ liệu đầu vào Buổi 16 nằm ở thư mục cùng cấp được lưu tại thư mục buoi_15
SOURCE_SECURE_CSV=../buoi_15/data/processed/chunks_secure.csv
SOURCE_NORMALIZED_CSV=../buoi_15/data/processed/chunks_normalized.csv
...
Folder Buổi 17 nằm cùng cấp với Buổi 15.

Dữ liệu đầu vào chính:
../buoi_15/data/processed/chunks_secure.csv

Dữ liệu đối chiếu:
../buoi_15/data/processed/chunks_normalized.csv
...
# PROMPT 0 — Đọc dữ liệu và code Buổi 15, 16 trước khi làm
...
Tìm code SecureRetriever mà Buổi 15 và 16 đang dùng.
Báo:
- file/module;
- hàm/class chính;
- input role;
...
```text
Tái sử dụng SecureRetriever của Buổi 15 cho Buổi 17.
...
# bỏ nội dung này, thay thế dòng bên dưới../buoi_15/data/processed/chunks_secure.csv
